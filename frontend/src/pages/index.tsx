...
export default function LandingPage() {
    return (
        <>
            ...
            <header className="flex h-28 w-full items-center justify-center sm:absolute">
                <Logo type={"full"} />
            </header>

            <div className="w-full overflow-hidden">
                <main className="mx-auto min-h-[calc(100vh-9rem)] max-w-[calc(100vw-40px)] md:max-w-3xl">
                    <section className="mb-6 sm:mb-0 sm:flex sm:min-h-screen sm:flex-col sm:justify-center">
                    ...
                    <section className="relative flex flex-col justify-between gap-6">
                        <div className="absolute -left-full -z-10 h-full w-[200vw] bg-blue-600"></div>
